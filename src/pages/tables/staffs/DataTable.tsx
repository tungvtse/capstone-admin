...
import { setStaffCount } from '@/store/counteSlice';
...
const DataTable = () => {
    ...
    const filteredData = () => {
        const filtered = data.filter((item) => item.attributes.username.includes(searchKeyword));
        ...
        <>
            ...
            >
                ...
                <Column width={150} sortable>
                    <HeaderCell style={{ color: '#373d58', fontWeight: 'bold', fontSize: '14px' }}>Tài khoản </HeaderCell>
                    <Cell style={{
                        alignItems: 'center',
                        paddingTop: ''
                    }} >
                ...
                <Column width={350}>
                    <HeaderCell style={{ color: '#373d58', fontWeight: 'bold', fontSize: '14px' }}>Địa chỉ trạm</HeaderCell>
                    <Cell style={{
                        alignItems: 'center',
                        paddingTop: ''
                    }} >
                        {rowData => {
                            ...
                            return (<Typography fontSize={'14px'} width="80%" color="#575757" >
                                {rowData.attributes.hub.address}
                            </Typography>)
                        }}
                    </Cell>
                </Column>
                <Column width={100}>
                    <HeaderCell style={{ color: '#373d58', fontWeight: 'bold', fontSize: '14px' }}>Tên trạm</HeaderCell>
                    <Cell style={{
                        paddingTop: ''
                    }} >
                        {rowData => {
